...
const getVideos_1 = require("./handlers/getVideos");
const getVideoById_1 = require("./handlers/getVideoById");
const express_1 = require("express");
const createVideo_1 = require("./handlers/createVideo");
const updateVideo_1 = require("./handlers/updateVideo");
const deleteVideoById_1 = require("./handlers/deleteVideoById");
